...
impl From<xdg_toplevel::ResizeEdge> for ResizeEdge {
    ...
    fn from(x: xdg_toplevel::ResizeEdge) -> Self {
        Self::from_bits(x as u32).unwrap_or(Self::BOTTOM_RIGHT)
    }
}
...
impl PointerGrab<CanvasWM> for ResizeSurfaceGrab {
    fn motion(
        &mut self,
        data: &mut CanvasWM,
    ...
    fn gesture_swipe_begin(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GestureSwipeBeginEvent) { handle.gesture_swipe_begin(data, event) }
    fn gesture_swipe_update(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GestureSwipeUpdateEvent) { handle.gesture_swipe_update(data, event) }
    fn gesture_swipe_end(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GestureSwipeEndEvent) { handle.gesture_swipe_end(data, event) }
    fn gesture_pinch_begin(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GesturePinchBeginEvent) { handle.gesture_pinch_begin(data, event) }
    fn gesture_pinch_update(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GesturePinchUpdateEvent) { handle.gesture_pinch_update(data, event) }
    fn gesture_pinch_end(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GesturePinchEndEvent) { handle.gesture_pinch_end(data, event) }
    fn gesture_hold_begin(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GestureHoldBeginEvent) { handle.gesture_hold_begin(data, event) }
    fn gesture_hold_end(&mut self, data: &mut CanvasWM, handle: &mut PointerInnerHandle<'_, CanvasWM>, event: &GestureHoldEndEvent) { handle.gesture_hold_end(data, event) }
